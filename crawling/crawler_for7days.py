                        ...
                        for h in range(1, len(theater_elements) + 1):
                            try:
                                ...
                                if theatercd_value:
                                    ...
                                    print("Theater Name:", theater_name, day)
                                    ...
                                    for k in range(1, len(movie_elements) + 1):
                                        try:
                                            ...
                                            if title_element is None:
                                                print(widearea_name, basarea_name, '상영스케줄 없음', theater_name, day)
                                                continue
                                ...
                                continue
                        day_selector = '#next > span'
                        day_element = safe_find_element(driver, day_selector)
                        day_element.click()
                        time.sleep(2)
            except Exception as e:
